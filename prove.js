...
function stampPrice(req, res){
	...
	var mailName = req.query.mailType;
	var weightOfMail = req.query.weight;
	var mailPrice = getMailPrice(mailName, weightOfMail);
	console.log('Got the mail Price');
	var stuff = {mailName: mailName, weightOfMail: weightOfMail, mailPrice: mailPrice}
